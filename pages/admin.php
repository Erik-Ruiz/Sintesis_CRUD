<?php
  ...
  if($matricula or $nombre or $apellido1 or $apellido2 or $correo or $dni){
      ?>
...
<div class="container-fluid">
  ...
  <div class="tabla" style="overflow: scroll;height:80vh">
    ...
    <thead>
     <form class="d-flex" role="search" method="POST" action="./filtrado.php">
        <tr>
          <th scope="col"><input name="matricula" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
          <th scope="col"><input name="nombre" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
          <th scope="col"><input name="apellido1" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
          <th scope="col"><input name="apellido2" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
          <th scope="col"><input name="correo" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
          <th scope="col"><input name="dni" class="form-control me-2" type="search" placeholder="Search" aria-label="Search"></th>
    ...
    <?php
    foreach ($listaAlumnso as $registro){
    ?>
      <tr>
